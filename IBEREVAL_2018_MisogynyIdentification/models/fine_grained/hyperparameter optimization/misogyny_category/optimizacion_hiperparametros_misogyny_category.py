...
for train_file in train_files:
    ...
    train_df = pd.DataFrame({"text": X_train, "misogyny_category": y_train})
    val_df = pd.DataFrame({"text": X_val, "misogyny_category": y_val})
    ...
    for model_name, config in models_dict.items():
        ...
        trainer = HateSpeechClassifier(model_name, config, train_file_name, y_col="misogyny_category", train_file=train_file)
        trainer.train()
