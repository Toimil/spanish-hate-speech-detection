...
parser = argparse.ArgumentParser(description="Entrenamiento y evaluación de un modelo SVM kernel lineal para target.")
...
print("SVM kernel lineal multiclase para target")
print("\n-----------------------------------------------------")
print("\n-----------------------------------------------------")
