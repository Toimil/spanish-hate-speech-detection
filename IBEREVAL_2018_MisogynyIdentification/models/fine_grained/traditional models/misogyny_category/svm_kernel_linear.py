...
parser = argparse.ArgumentParser(description="Entrenamiento y evaluación de un modelo SVM kernel lineal para misogyny_category.")
...
y = df_train_full["misogyny_category"]
...
print("SVM kernel lineal multiclase para misogyny_category")
print("\n-----------------------------------------------------")
print("\n-----------------------------------------------------")


param_grid = {'C': [0.01, 0.1, 1, 10, 100]}
grid = GridSearchCV(SVC(kernel='linear', random_state=SEED_VALUE, decision_function_shape='ovr'), param_grid, scoring='f1_macro', cv=5)
...
evaluar_modelo(best_model, X_test_tfidf, df_test["misogyny_category"], "test")
