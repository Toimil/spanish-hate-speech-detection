...
parser = argparse.ArgumentParser(description="Entrenamiento y evaluación de un modelo SVM kernel rbf para misogyny_category.")
...
print("SVM kernel rbf para misogyny_category")
print("\n-----------------------------------------------------")
print("\n-----------------------------------------------------")
