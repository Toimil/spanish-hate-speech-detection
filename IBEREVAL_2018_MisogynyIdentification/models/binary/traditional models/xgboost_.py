...
parser = argparse.ArgumentParser(description="Entrenamiento y evaluación de un modelo XGBoost")
...
evaluar_modelo(best_model, X_test_tfidf, df_test["misogynous"], "test")
