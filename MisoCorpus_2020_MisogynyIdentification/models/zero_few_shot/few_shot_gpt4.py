...
Algunos ejemplos:
Texto: "las mujeres como greta thunberg no deberían trabajar, su lugar está en casa." ¿Es misógino?: sí   
Texto: "que hijo de puta, te ha tocado la loteria" ¿Es misógino?: no 
Texto: "las mujeres son todas unas putas y feminazis, no sirven para nada" ¿Es misógino?: sí
...
if __name__ == "__main__":
    ...
    test_preds = few_shot_clasificar(df_test["tweet"].tolist())
    evaluar(df_test["label"], test_preds, "test")
