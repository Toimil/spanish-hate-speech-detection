...
class HateSpeechClassifier:
    ...
    def objective(self, trial):
        ...
        dataset = load_dataset('csv', data_files={'train': 'misocorpus_train_split.csv', 'validation': 'misocorpus_val_split.csv'})
...
train_files = [
    'misocorpus2020_train.csv'
]

val_files = [
    'misocorpus2020_val.csv'
]
...
for train_file, val_file in zip(train_files, val_files):
    ...
    df_train = cargar_dataset(train_file)
    #df_val = cargar_dataset(args.val_file)
    df_val = cargar_dataset(val_file)
    ...
    train_df.to_csv("misocorpus_train_split.csv", index=False)
    val_df.to_csv("misocorpus_val_split.csv", index=False)
