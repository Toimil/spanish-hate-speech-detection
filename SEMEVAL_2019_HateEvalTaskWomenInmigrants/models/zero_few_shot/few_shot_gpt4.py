...
def construir_prompt(texto):
    return f"""Decide si el siguiente texto es misógino/discurso de odio contra los inmigrantes o no. Responde únicamente con 'sí' o 'no'.
Algunos ejemplos:
Texto: "las mujeres no deberían trabajar, su lugar está en casa." ¿Es misógino o un discurso de odio contra los inmigrantes?: sí   
Texto: "que hijo de puta, te ha tocado la loteria" ¿Es misógino o un discurso de odio contra los inmigrantes?: no 
Texto: "todos los inmigrantes vienen a quitarnos el trabajo" ¿Es misógino o un discurso de odio contra los inmigrantes?: sí
Texto: "mi primo es árabe y juega muy bien al fútbol" ¿Es misógino o un discurso de odio contra los inmigrantes?: no

Ahora decide si el siguiente texto es misógino/discurso de odio contra los inmigrantes o no. Responde únicamente con 'sí' o 'no'.
Texto: "{texto}"
¿Es misógino o un discurso de odio contra los inmigrantes?: """
...
if __name__ == "__main__":
    ...
    evaluar(df_test["hate_speech"], test_preds, "test")
